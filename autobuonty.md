repeat wait()
until game:IsLoaded()
local TableChat = {"Banana Is The Best And You Are Weak As Dogs Now","I'm Using Banana Hub","No Skill? Use Banana Hub now"}
spawn(function()
    while wait() do 
        pcall(function()
...
getgenv().Setting = {
    ...
    ["Webhook"] = {
        ["Enabled"] = true,
        ["Url Webhook"] = "https://discord.com/api/webhooks/1195961947145896016/10peSb8ZXE8XUwdtsBoU0zC6ID7K8HkvXXgPko-ustGqckBlwQ0eJ-m3AG6KAaqD-yqm", --Your Url
    },
    ["Misc"] = {
